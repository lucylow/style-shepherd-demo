 ...
 *   or set env vars and run: DEPLOY_URL=https://app.example.com node scripts/register_agent.js
 */
...
console.log('\nIf you want, run `node scripts/register_agent.js DEPLOY_URL=https://app.example.com` to auto-fill the URL.\n');
